  ...
  return (
    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h1 class="display-4 mb-4"><span class="text-primary">Adoption</span> & <span class="text-secondary">Clinics</span></h1>
    ...
    <div class="container pt-5">
        <div class="d-flex flex-column text-center mb-5">
            ...
            <h1 class="display-4 m-0"><span class="text-primary">Browse</span> Now</h1>
        </div>
        <div class="row pb-3">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 mb-2">
                    ...
                    <div class="card-body bg-light p-4">
                        ...
                        <div class="d-flex mb-3">
                            <small class="mr-2"><i class="fa flaticon-dog text-muted"></i> German shepard</small>
                            <small class="mr-2"><i class="fa fa-calendar text-muted"></i> 3 year old</small>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 mb-2">
                    ...
                    <div class="card-body bg-light p-4">
                        ...
                        <div class="d-flex mb-3">
                            <small class="mr-2"><i class="fa flaticon-dog text-muted"></i> Golden Retriver</small>
                            <small class="mr-2"><i class="fa fa-calendar text-muted"></i> 5 year old</small>
