          ...
          <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
              ...
              <h5 class="text-muted mb-3">
                At Aleefy, we're more than just a pet platform—we're a
                passionate community dedicated to serving the needs of Egypt's
                pet lovers and industry professionals. Founded with a vision to
                bridge gaps and enhance connections within the pet community,
                Aleefy is your trusted partner in all things pet-related.
              </h5>
              <ul class="list-inline">
                <li>
                  <h5>
                    <i class="fa fa-check-double text-secondary mr-3"></i>Our
                    Mission
                  </h5>
                </li>
                <p class="mb-4">
                  At the core of Aleefy's mission is a commitment to creating a
                  vibrant and inclusive space where pets and their owners can
                  thrive. We strive to provide a platform that fosters
                  meaningful connections, promotes pet welfare, and empowers
                  individuals to make informed decisions about their pet's care.{" "}
                </p>
                <li>
                  <h5>
                    <i class="fa fa-check-double text-secondary mr-3"></i>Our
                ...
                <p class="mb-4">
                  Our vision is to become the leading destination for pet
                  enthusiasts in Egypt, offering a comprehensive range of
                  services, resources, and support to enrich the lives of pets
                  and their owners. Through innovation, collaboration, and a
                  deep understanding of the needs of the pet community, we aim
                  to redefine the standards of pet care and advocacy in Egypt
                  and beyond.
                </p>
                <li>
                  <h5>
                    <i class="fa fa-check-double text-secondary mr-3"></i>What
                    sets us a part
                  </h5>
                </li>
                <p class="mb-4">
                  Aleefy stands out from other platforms thanks to our unique
                  blend of community engagement, convenience, and reliability.
                  We're more than just a marketplace—we're a hub for pet lovers
                  to connect, learn, and grow together. Whether you're seeking
                  pet care services, product recommendations, or simply looking
                  to connect with like-minded individuals, Aleefy has something
                  for everyone.
                </p>
              </ul>
            </div>
