                ...
                <div class="col-lg-4 mb-4">
                    <div class="card border-0">
                        <div class="card-header position-relative border-0 p-0 mb-4">
                            ...
                            <div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style={divStyle}>
                                ...
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top">$</small>49<small class="align-bottom" >/ Mo</small>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="card-footer border-0 p-0">
                            <a href="" class="btn btn-primary btn-block p-3">Signup Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card border-0">
                        <div class="card-header position-relative border-0 p-0 mb-4">
                            ...
                            <div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style={divStyle}>
                                ...
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top">$</small>99<small class="align-bottom" >/ Mo</small>
                                </h1>
                            </div>
                        </div>
                        <div class="card-body text-center p-0">
                        ...
                        <div class="card-footer border-0 p-0">
                            <a href="" class="btn btn-secondary btn-block p-3" >Signup Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mb-4">
                    <div class="card border-0">
                        <div class="card-header position-relative border-0 p-0 mb-4">
                            ...
                            <div class="position-absolute d-flex flex-column align-items-center justify-content-center w-100 h-100" style={divStyle}>
                                ...
                                <h1 class="display-4 text-white mb-0">
                                    <small class="align-top" >$</small>149<small class="align-bottom" >/ Mo</small>
                                </h1>
                            </div>
                        </div>
                        <div class="card-body text-center p-0">
