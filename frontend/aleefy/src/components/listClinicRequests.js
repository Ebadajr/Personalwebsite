...
function ListclinicRequests() {
  ...
  useEffect(() => {
    async function fetchBookings() {
      try {
        const response = await fetch("http://localhost:7000/getClinicRequests");
              ...
              <div className="col-lg-4" key={index}>
                <div className="card">
                  <div className="card-body">
                    ...
                    <p className="card-text">Location: {booking.Address}</p>
                  </div>
                  <button
...
export default ListclinicRequests;
